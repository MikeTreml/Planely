...
function buildTaskAuthoringPreview(payload, root = getActiveProjectRoot()) {
  ...
  const promptMarkdown = taskId && folderName && scoreTotal != null && reviewLevel != null
    ? [
      ...
      "- [ ] Update docs if the change ships user-facing behavior",
      ...
      "## Completion Criteria",
      "",
      "- [ ] Operator can execute the requested change from the generated packet",
      "- [ ] Packet remains compatible with `/orch`",
      "",
